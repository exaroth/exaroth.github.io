...
},beforeSetClass:function(a,b,c,d){var e=E(c,"-remove")+" "+E(b,"-add"),f=A("setClass",a,e,function(d){var e=a.attr("class");a.removeClass(c),a.addClass(b);var f=d();return a.attr("class",e),f});return f?(l(a,function(){w(a,e),x(a),d()}),f):(i(),void d())},beforeAddClass:function(a,b,c){var d=A("addClass",a,E(b,"-add"),function(c){a.addClass(b);var d=c();return a.removeClass(b),d});return d?(l(a,function(){w(a,b),x(a),c()}),d):(i(),void c())},setClass:function(a,b,c,d){c=E(c,"-remove"),b=E(b,"-add");var e=c+" "+b;return B("setClass",a,e,d)},addClass:function(a,b,c){return B("addClass",a,E(b,"-add"),c)},beforeRemoveClass:function(a,b,c){var d=A("removeClass",a,E(b,"-remove"),function(c){var d=a.attr("class");a.removeClass(b);var e=c();return a.attr("class",d),e});return d?(l(a,function(){w(a,b),x(a),c()}),d):void c()},removeClass:function(a,b,c){return B("removeClass",a,E(b,"-remove"),c)}}}])}])}(window,window.angular),function(a,b,c){"use strict";function d(){this.$get=["$$sanitizeUri",function(a){return function(b){var c=[];return g(b,j(c,function(b,c){return!/^unsafe/.test(a(b,c))})),c.join("")}}]}function e(a){var c=[],d=j(c,b.noop);return d.chars(a),c.join("")}function f(a){var b,c={},d=a.split(",");for(b=0;b<d.length;b++)c[d[b]]=!0;return c}function g(a,c){function d(a,d,f,g){if(d=b.lowercase(d),z[d])for(;t.last()&&A[t.last()];)e("",t.last());y[d]&&t.last()==d&&e("",d),g=v[d]||!!g,g||t.push(d);var i={};f.replace(n,function(a,b,c,d,e){var f=c||d||e||"";i[b]=h(f)}),c.start&&c.start(d,i,g)}function e(a,d){var e,f=0;if(d=b.lowercase(d))for(f=t.length-1;f>=0&&t[f]!=d;f--);if(f>=0){for(e=t.length-1;e>=f;e--)c.end&&c.end(t[e]);t.length=f}}"string"!=typeof a&&(a=null===a||"undefined"==typeof a?"":""+a);var f,g,i,j,t=[],u=a;for(t.last=function(){return t[t.length-1]};a;){if(j="",g=!0,t.last()&&B[t.last()]?(a=a.replace(new RegExp("(.*)<\\s*\\/\\s*"+t.last()+"[^>]*>","i"),function(a,b){return b=b.replace(q,"$1").replace(s,"$1"),c.chars&&c.chars(h(b)),""}),e("",t.last())):(0===a.indexOf("<!--")?(f=a.indexOf("--",4),f>=0&&a.lastIndexOf("-->",f)===f&&(c.comment&&c.comment(a.substring(4,f)),a=a.substring(f+3),g=!1)):r.test(a)?(i=a.match(r),i&&(a=a.replace(i[0],""),g=!1)):p.test(a)?(i=a.match(m),i&&(a=a.substring(i[0].length),i[0].replace(m,e),g=!1)):o.test(a)&&(i=a.match(l),i?(i[4]&&(a=a.substring(i[0].length),i[0].replace(l,d)),g=!1):(j+="<",a=a.substring(1))),g&&(f=a.indexOf("<"),j+=0>f?a:a.substring(0,f),a=0>f?"":a.substring(f),c.chars&&c.chars(h(j)))),a==u)throw k("badparse","The sanitizer was unable to parse the following block of html: {0}",a);u=a}e()}function h(a){if(!a)return"";var b=G.exec(a),c=b[1],d=b[3],e=b[2];return e&&(F.innerHTML=e.replace(/</g,"&lt;"),e="textContent"in F?F.textContent:F.innerText),c+e+d}function i(a){return a.replace(/&/g,"&amp;").replace(t,function(a){var b=a.charCodeAt(0),c=a.charCodeAt(1);return"&#"+(1024*(b-55296)+(c-56320)+65536)+";"}).replace(u,function(a){return"&#"+a.charCodeAt(0)+";"}).replace(/</g,"&lt;").replace(/>/g,"&gt;")}function j(a,c){var d=!1,e=b.bind(a,a.push);return{start:function(a,f,g){a=b.lowercase(a),!d&&B[a]&&(d=a),d||C[a]!==!0||(e("<"),e(a),b.forEach(f,function(d,f){var g=b.lowercase(f),h="img"===a&&"src"===g||"background"===g;E[g]!==!0||D[g]===!0&&!c(d,h)||(e(" "),e(f),e('="'),e(i(d)),e('"'))}),e(g?"/>":">"))},end:function(a){a=b.lowercase(a),d||C[a]!==!0||(e("</"),e(a),e(">")),a==d&&(d=!1)},chars:function(a){d||e(i(a))}}}var k=b.$$minErr("$sanitize"),l=/^<((?:[a-zA-Z])[\w:-]*)((?:\s+[\w:-]+(?:\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|[^>\s]+))?)*)\s*(\/?)\s*(>?)/,m=/^<\/\s*([\w:-]+)[^>]*>/,n=/([\w:-]+)(?:\s*=\s*(?:(?:"((?:[^"])*)")|(?:'((?:[^'])*)')|([^>\s]+)))?/g,o=/^</,p=/^<\//,q=/<!--(.*?)-->/g,r=/<!DOCTYPE([^>]*?)>/i,s=/<!\[CDATA\[(.*?)]]>/g,t=/[\uD800-\uDBFF][\uDC00-\uDFFF]/g,u=/([^\#-~| |!])/g,v=f("area,br,col,hr,img,wbr"),w=f("colgroup,dd,dt,li,p,tbody,td,tfoot,th,thead,tr"),x=f("rp,rt"),y=b.extend({},x,w),z=b.extend({},w,f("address,article,aside,blockquote,caption,center,del,dir,div,dl,figure,figcaption,footer,h1,h2,h3,h4,h5,h6,header,hgroup,hr,ins,map,menu,nav,ol,pre,script,section,table,ul")),A=b.extend({},x,f("a,abbr,acronym,b,bdi,bdo,big,br,cite,code,del,dfn,em,font,i,img,ins,kbd,label,map,mark,q,ruby,rp,rt,s,samp,small,span,strike,strong,sub,sup,time,tt,u,var")),B=f("script,style"),C=b.extend({},v,z,A,y),D=f("background,cite,href,longdesc,src"),E=b.extend({},D,f("abbr,align,alt,axis,bgcolor,border,cellpadding,cellspacing,class,clear,color,cols,colspan,compact,coords,dir,face,headers,height,hreflang,hspace,ismap,lang,language,nohref,nowrap,rel,rev,rows,rowspan,rules,scope,scrolling,shape,size,span,start,summary,target,title,type,valign,value,vspace,width")),F=document.createElement("pre"),G=/^(\s*)([\s\S]*?)(\s*)$/;b.module("ngSanitize",[]).provider("$sanitize",d),b.module("ngSanitize").filter("linky",["$sanitize",function(a){var c=/((ftp|https?):\/\/|(mailto:)?[A-Za-z0-9._%+-]+@)\S*[^\s.;,(){}<>"]/,d=/^mailto:/;return function(f,g){function h(a){a&&n.push(e(a))}function i(a,c){n.push("<a "),b.isDefined(g)&&(n.push('target="'),n.push(g),n.push('" ')),n.push('href="',a.replace('"',"&quot;"),'">'),h(c),n.push("</a>")}if(!f)return f;for(var j,k,l,m=f,n=[];j=m.match(c);)k=j[0],j[2]==j[3]&&(k="mailto:"+k),l=j.index,h(m.substr(0,l)),i(k,j[0].replace(d,"")),m=m.substring(l+j[0].length);return h(m),a(n.join(""))}}])}(window,window.angular),function(){function a(){window.addEventListener("load",function(){b()})}function b(){c.classList.remove("loading")}window.computedWindowWidth=window.outerWidth;var c=(document.getElementsByTagName("body")[0],document.getElementsByTagName("html")[0]);document.addEventListener("DOMContentLoaded",function(){a()});var d=angular.module("konrad-webpage",["ngRoute","ngAnimate","ngSanitize","d3","directives"]);d.config(["$routeProvider","$locationProvider",function(a,b){console.log("clicked"),b.html5Mode(!0).hashPrefix("!"),a.when("/",{templateUrl:"/partials/_main_page.html",controller:"IndexController",controllerAs:"indexCtrl"}).when("/skills",{templateUrl:"/partials/_skills_page.html",controller:"SkillsController",controllerAs:"skillsCtrl"}).when("/portfolio",{templateUrl:"partials/_portfolio_page.html",controller:"PortfolioController",controllerAs:"PortfolioCtrl",resolve:{portfolioItems:["$q","$http",function(a,b){console.log("portfolio");var c=a.defer();return b.get("/portfolio.json").then(function(a){c.resolve(a)}),c.promise}]}}).when("/contact",{templateUrl:"partials/_contact_page.html",controller:"ContactController",controllerAs:"contactCtrl"}).otherwise({redirectTo:"/"})}]),d.factory("JSONFactory",["$http",function(a){var b={};return b.transData=null,b.skillData=null,b.getLangData=function(){var b=this,c=a.get("/translations.json").success(function(a){b.transData=a}).error(function(){throw"Error retrieving data from the server"});return c},b.translateData=function(a){var b={};return angular.forEach(this.transData,function(c,d){b[d]={},angular.forEach(c,function(c,e){b[d][e]=c[a]})},b),b},b}]),d.controller("MainController",["$scope","$timeout","$location","JSONFactory",function(a,b,c,d){function e(c){var e=d.getLangData();e.success(function(){b(function(){a.trans=d.translateData(c)})})}function f(){return a.langVal}a.langVal=0,a.trans={},a.classes={},a.classes.overlayClass="index-bg",a.classes.logoClass="index-logo-color",e(f.call(this)),a.portfolioItems={},this.switchLang=function(){a.langVal=langVal=a.langVal?0:1,b(function(){a.$apply(function(){a.trans=d.translateData(a.langVal)})})},a.linkSelected=function(a){return a===c.path()}}]),d.controller("IndexController",["$scope","d3Service",function(a,b){a.classes.overlayClass="index-bg",a.classes.logoClass="index-logo-color",a.$on("$destroy",function(){b.d3().then(function(a){a.select("canvas").remove()})})}]),d.controller("PortfolioController",["$scope","$http","$timeout","portfolioItems",function(a,b,c,d){a.classes.overlayClass="portfolio-bg",a.classes.logoClass="portfolio-logo-color",a.portfolioItems=d.data,a.displayedItem=null,a.modalShown=!1,console.log("portfolio"),a.toggleModal=function(){a.modalShown=a.ModalShown?!1:!0},this.showPortfolioModal=function(b){a.displayedItem=b,a.toggleModal()}}]),d.controller("ContactController",["$scope","$http",function(a,b){a.classes.overlayClass="contact-bg",a.classes.logoClass="contact-logo-color",a.showContactModal=!1,a.contactBtnDisabled=!0,a.contactModalText="Nothing to display",this.inputs={},this.sendEmail=function(){a.showContactModal=!0,a.contactBtnDisabled=!0,a.contactModalText="Sending message...";var c=this;b({method:"post",url:"https://mandrillapp.com/api/1.0/messages/send.json",data:{key:"Y4xeAHfEJDYLTRg0I0CXBQ",message:{from_email:c.inputs.email,to:[{email:"exaroth@gmail.com",name:"Konradek",type:"to"}],autotext:"true",subject:"Kontakt ze stronki",text:c.inputs.username+" writes \r"+c.inputs.message}}}).error(function(b){a.contactModalText="Error when sending your message please try again later",a.contactBtnDisabled=!1}).success(function(b){a.contactModalText="Message succesfully sent. Thanks!!",a.contactBtnDisabled=!1})}}]),d.filter("reverse",function(){return function(a){return a.slice().reverse()}})}(),angular.module("d3",[]).factory("d3Service",["$document","$q","$rootScope",function(a,b,c){function d(){c.$apply(function(){e.resolve(window.d3)})}var e=b.defer(),f=a[0].createElement("script");f.type="text/javascript",f.async=!0,f.src="https://d3js.org/d3.v3.min.js",f.onreadystatechange=function(){"complete"==this.readyState&&d()},f.onload=d;var g=a[0].getElementsByTagName("body")[0];return g.appendChild(f),{d3:function(){return e.promise}}}]),angular.module("directives",["d3"]).directive("floatingOrb",["d3Service",function(a){return{restrict:"EA",link:function(b,c,d){a.d3().then(function(a){function d(){n.clearRect(0,0,i,h),n.beginPath(),n.strokeStyle="rgba(0,180,225,1)",n.lineWidth=.7,n.setLineDash([2,2]),n.beginPath(),p(q),n.stroke()}!function(){function b(b){return a.merge(i.map(function(a){var c=d(a[0],a[1]),e=d(a[0],a[2]),f=[];f.push([a[0],c(1/b),e(1/b)]);for(var g=1;b>g;++g){for(var h=d(c(g/b),e(g/b)),i=d(c((g+1)/b),e((g+1)/b)),j=0;g>=j;++j)f.push([h(j/g),i(j/(g+1)),i((j+1)/(g+1))]);for(var j=0;g>j;++j)f.push([h(j/g),h((j+1)/g),i((j+1)/(g+1))])}return f}))}function c(c){function d(a,b){var c;(a[0]<b[0]||a[0]==b[0]&&(a[1]<b[1]||a[1]==b[1]&&a[2]<b[2]))&&(c=a,a=b,b=c),f[a.map(e)+" "+b.map(e)]=[a,b]}function e(b){return a.round(b,4)}var f={};return b(c).forEach(function(a){d(a[0],a[1]),d(a[1],a[2]),d(a[2],a[0])}),a.values(f)}function d(a,b){var c=a[0],d=a[1],e=a[2],f=b[0]-c,g=b[1]-d,h=b[2]-e;return function(a){return[c+a*f,d+a*g,e+a*h]}}function e(a){var b=a[0],c=a[1],d=a[2];return[Math.atan2(c,b)*g,Math.acos(d/Math.sqrt(b*b+c*c+d*d))*g-90]}var f=1.618033988749895,g=180/Math.PI,h=[[1,f,0],[-1,f,0],[1,-f,0],[-1,-f,0],[0,1,f],[0,-1,f],[0,1,-f],[0,-1,-f],[f,0,1],[-f,0,1],[f,0,-1],[-f,0,-1]],i=[[0,1,4],[1,9,4],[4,9,5],[5,9,3],[2,3,7],[3,2,5],[7,10,2],[0,8,10],[0,4,8],[8,2,10],[8,4,5],[8,5,2],[1,0,6],[11,1,6],[3,9,11],[6,10,7],[3,11,7],[11,6,7],[6,0,10],[9,1,11]].map(function(a){return a.map(function(a){return h[a]})});a.geodesic={multipolygon:function(a){return{type:"MultiPolygon",coordinates:b(~~a).map(function(a){return a=a.map(e),a.push(a[0]),[a]})}},polygons:function(b){return a.geodesic.multipolygon(~~b).coordinates.map(function(a){return{type:"Polygon",coordinates:a}})},multilinestring:function(a){return{type:"MultiLineString",coordinates:c(~~a).map(function(a){return a.map(e)})}}}}();var e=[-.01,.01],f=Date.now(),g=[0,0],h=c.parent()[0].offsetHeight,i=c.parent()[0].offsetWidth,j=!1,k=i/8,l=i/4,m=a.select(c[0]).append("canvas").attr("class","floating-orb");m.attr("height",h).attr("width",function(){return i});var n=m.node().getContext("2d"),o=a.geo.orthographic().scale(k).translate([l,h/2]),p=a.geo.path().projection(o).context(n),q=a.geodesic.multilinestring(4);a.timer(function(){var a=Date.now()-f,b=[g[0]+a*e[0],g[1]+a*e[1]];return o.rotate(b),d(),j}),b.$on("$destroy",function(){j=!0,n.clearRect(0,0,i,h)})})}}}]).directive("portfolioItem",[function(){return{restrict:"EA",scope:{item:"=portfolioItem",index:"@",trans:"=",langVal:"="},templateUrl:"partials/_portfolio_item.html",link:function(a,b,c){setTimeout(function(){b.parent()[0].classList.add("portfolio-item-active")},200+200*parseInt(a.index))}}}]).directive("portfolioModal",["$timeout",function(a){return{restrict:"E",scope:{modalShown:"=",item:"=",langVal:"=",trans:"="},replace:!0,templateUrl:"partials/_portfolio_modal.html",link:function(a,b,c){a.hideModal=function(){a.modalShown=!1}}}}]).directive("flyingThingies",function(){return{restrict:"EA",scope:!0,replace:!0,link:function(a,b,c){function d(a,b){return Math.random()*(b-a)+a}function e(){h=b.parent()[0].offsetWidth,i=b.parent()[0].offsetHeight;var a=document.createElement("canvas");a.classList.add("floating-thingies"),a.width=h,a.height=i,b[0].appendChild(a),g=a.getContext("2d"),g.fillStyle="transparent",g.fillRect(0,0,h,i),j=new Array}function f(){if(g.fillStyle="rgba(16, 64, 78, .05)",g.fillRect(0,0,h,i),j.length<400){var a=d(0,h),b=d(0,i);j.push(new k(a,b))}g.beginPath(),g.strokeStyle="rgba(0,255,255,.5)",g.lineWidth=2;for(var c=0;c<j.length;c++){var e=j[c];e.life++;var f=d(200,800);e.life>f?j.shift():(g.moveTo(e.x,e.y),e.rw+=Math.random()-.5,e.x+=Math.cos(e.rw),e.y+=Math.sin(e.rw),g.lineTo(e.x,e.y))}g.stroke(),g.closePath()}var g,h,i,j;e(),setInterval(f,1e3/60);var k=function(a,b){this.life=0,this.x=a,this.y=b,this.rw=Math.random()-.9}}}}).directive("sendModal",function(){return{restrict:"E",scope:{showContactModal:"=",contactModalText:"=",contactBtnDisabled:"="},templateUrl:"partials/_contact_modal.html",link:function(a,b,c){a.closeModal=function(){a.showContactModal=!1}}}});